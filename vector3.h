...
vector3_err_t vector3_sum(vector3_t const *vector1, vector3_t const *vector2,
                          vector3_t *sum);
...
vector3_err_t vector3_scale(vector3_t const *vector, vector3_data_t scalar,
                            vector3_t *scale);

vector3_err_t vector3_dot(vector3_t const *vector1, vector3_t const *vector2,
                          vector3_data_t *dot);

vector3_err_t vector3_cross(vector3_t const *vector1, vector3_t const *vector2,
                            vector3_t *cross);
