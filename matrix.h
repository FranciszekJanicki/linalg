...
matrix_err_t matrix_create(matrix_t *matrix, matrix_size_t rows,
                           matrix_size_t columns);

matrix_err_t matrix_create_with_zeros(matrix_t *matrix, matrix_size_t rows,
                                      matrix_size_t columns);

matrix_err_t
matrix_create_with_array(matrix_t *matrix, matrix_size_t rows,
                         matrix_size_t columns,
                         const matrix_data_t (*array)[rows][columns]);

matrix_err_t matrix_delete(matrix_t *matrix);

matrix_err_t matrix_resize(matrix_t *matrix, matrix_size_t rows,
                           matrix_size_t columns);

matrix_err_t matrix_resize_with_zeros(matrix_t *matrix, matrix_size_t rows,
                                      matrix_size_t columns);

matrix_err_t
matrix_resize_with_array(matrix_t *matrix, matrix_size_t rows,
                         matrix_size_t columns,
                         const matrix_data_t (*array)[rows][columns]);
...
matrix_err_t matrix_minor(matrix_t const *matrix, size_t minor_row,
                          size_t minor_column, matrix_t *minor);
...
matrix_err_t matrix_sum(matrix_t const *matrix1, matrix_t const *matrix2,
                        matrix_t *sum);

matrix_err_t matrix_difference(matrix_t const *matrix1, matrix_t const *matrix2,
                               matrix_t *difference);

matrix_err_t matrix_scale(matrix_t const *matrix, matrix_data_t scalar,
                          matrix_t *scale);

matrix_err_t matrix_product(matrix_t const *matrix1, matrix_t const *matrix2,
                            matrix_t *product);

matrix_err_t matrix_division(matrix_t const *matrix1, matrix_t const *matrix2,
                             matrix_t *division);

matrix_err_t matrix_power(matrix_t const *matrix, matrix_size_t exponent,
                          matrix_t *power);
...
matrix_err_t matrix_eigvals(matrix_t const *matrix, matrix_data_t **eigvals,
