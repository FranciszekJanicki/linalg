...
matrix3_err_t matrix3_minor(matrix3_t const *matrix, matrix3_size_t minor_row,
                            matrix3_size_t minor_column, matrix3_t *minor);
...
matrix3_err_t matrix3_sum(matrix3_t const *matrix1, matrix3_t const *matrix2,
                          matrix3_t *sum);
...
matrix3_err_t matrix3_scale(matrix3_t const *matrix, matrix3_data_t scalar,
                            matrix3_t *scale);

matrix3_err_t matrix3_product(matrix3_t const *matrix1,
                              matrix3_t const *matrix2, matrix3_t *product);

matrix3_err_t matrix3_division(matrix3_t const *matrix1,
                               matrix3_t const *matrix2, matrix3_t *division);

matrix3_err_t matrix3_power(matrix3_t const *matrix, matrix3_size_t exponent,
                            matrix3_t *power);
